export const agents = [
  {
    ...
    signature: 'https://i.postimg.cc/kgyYD5P1/1.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/tR1tZNx7/kadeupyoji-0000s-0011-leieo-11.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/sXhkNRb6/jemog-eobs-eum-1-0011-aesyeo.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '191cm', weight: '98kg', vision: '20/15', blood: 'B-POS', footSize: 'UK10.5', smoking: 'Yes' },
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/NFXVfqtB/jemog-eobs-eum-1-0000-leieo-1-0010-leieo-11.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/V6vvh482/kadeupyoji-0000s-0010-leieo-12.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/zG7QfFs0/jemog-eobs-eum-1-0010-maegseu.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '193cm', weight: '105kg', vision: '20/15', blood: 'O-NEG', footSize: 'US13', smoking: 'No' },
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/d1LppZSL/dddd.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/pLQm5pCG/kadeupyoji-0000s-0009-leieo-13.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/pVj1jvNb/jemog-eobs-eum-1-0009-oseuka.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '187cm', weight: '87kg', vision: '20/15', blood: 'A-POS', footSize: 'US11', smoking: 'Yes' },
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/pLvNrTpT/ddd.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/c1jgpq6R/kadeupyoji-0000s-0008-leieo-14.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/gjbssw9r/jemog-eobs-eum-1-0008-elig.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '188cm', weight: '95kg', vision: '20/20', blood: 'B-POS', footSize: 'US11', smoking: 'Yes' },
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/B6B4ZKBT/jemog-eobs-eum-1-0000-leieo-1-0007-leieo-8.png0', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/x1LzGsfz/kadeupyoji-0000s-0007-leieo-15.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/Hkk26DN4/jemog-eobs-eum-1-0007-neiseun.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '192cm', weight: '103kg', vision: '20/15', blood: 'O-POS', footSize: 'US13', smoking: 'Yes' },
    outside: 'M249E4 SAW',
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/gcLH7H4g/jemog-eobs-eum-1-0000-leieo-1-0004-leieo-5.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/5NTBSYwM/kadeupyoji-0000s-0004-leieo-18.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/BbJDt29t/jemog-eobs-eum-1-0004-binsenteu.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '188cm', weight: '97kg', vision: '20/20', blood: 'A-POS', footSize: 'US11', smoking: 'Yes' },
    outside: 'Heckler & Koch HK416',
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/jScHfgd5/jemog-eobs-eum-1-0000-leieo-1-0005-leieo-6.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/bJykwQjN/kadeupyoji-0000s-0005-leieo-17.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/JzFbKyJK/jemog-eobs-eum-1-0005-laul.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '186cm', weight: '85kg', vision: '20/15', blood: 'A-NEG', footSize: 'US10.5', smoking: 'Yes' },
    outside: 'Mk. 18 CQBR',
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/QtQxBPh0/dd.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/hvwds6Qf/kadeupyoji-0000s-0006-leieo-16.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/T1xjmZmp/jemog-eobs-eum-1-0006-aijag.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '187cm', weight: '96kg', vision: '20/20', blood: 'O-NEG', footSize: 'US11', smoking: 'No' },
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/W3hwTGVV/jemog-eobs-eum-1-0000-leieo-1-0003-leieo-4.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/tJg32FSG/kadeupyoji-0000s-0003-leieo-19.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/6p8Z79SY/jemog-eobs-eum-1-0003-beulleikeu.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '188cm', weight: '94kg', vision: '20/40', blood: 'O-POS', footSize: 'UK10', smoking: 'No' },
    outside: 'Heckler & Koch HK416',
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/2jg2jK3g/jemog-eobs-eum-1-0000-leieo-1-0002-leieo-3.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/mrQyDLzJ/kadeupyoji-0000s-0002-leieo-20.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/j5bnky5K/jemog-eobs-eum-1-0002-jei.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '187cm', weight: '93kg', vision: '20/20', blood: 'A-POS', footSize: 'US11', smoking: 'Yes' },
    outside: 'Heckler & Koch HK416',
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/rmPRJ3vs/jemog-eobs-eum-1-0000-leieo-1-0001-leieo-2.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/4NS52FR0/kadeupyoji-0000s-0001-leieo-21.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/QC6BtPJv/jemog-eobs-eum-1-0001-josyua.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '183cm', weight: '83kg', vision: '20/10', blood: 'A-NEG', footSize: 'US10.5', smoking: 'No' },
  ...
  },
  {
    ...
    signature: 'https://i.postimg.cc/vH6fP88d/jemog-eobs-eum-1-0000-leieo-1-0000-leieo-1.png', // ■사인 이미지 (500x200)■
    idCardFront: 'https://i.postimg.cc/kgLTGYjv/kadeupyoji-0000s-0000-leieo-22.png', // ■신분증 앞면 이미지 (2:3 비율)■
    fingerprint: 'https://i.postimg.cc/J42DCfnP/jemog-eobs-eum-1-0000-kollin.jpg', // ■지문 이미지 (3:4 비율)■
    stats: { height: '185cm', weight: '83kg', vision: '20/20', blood: 'AB-POS', footSize: 'US11', smoking: 'No' },
    outside: 'Heckler & Koch HK416',
